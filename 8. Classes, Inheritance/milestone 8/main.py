...
# Alice is a bookworm, she adores reading and organizing books.
#  One day she comes to Bob’s home and sees the total mess in his books - 
# they are all over his room without any order or structure. She can't leave it this way!
# Let's help Alice using our new knowledge.
#  We will build a digital catalog for Bob and make it easier for Alice to order the books.
# First of all, create a UML diagram of the domain. 
# You're free to choose classes and names to model, but be sure to include classes Book and Shelf.
...
# There can be more categories than books, so one shelf can contain multiple categories.
